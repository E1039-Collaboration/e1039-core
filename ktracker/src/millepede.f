* $Id: millepede.f,v 1.2 2010/04/05 00:58:27 hpereira Exp $
...
*     Basic dimension parameters
      PARAMETER (MGLOBL=3000,MLOCAL=10,NSTORE=100000,MCS=900) ! dimensions
...
*     ...
      ...
      IF(NAGB.GT.MGLOBL.OR.NALC.GT.MLOCAL) THEN
         WRITE(*,*) 'Too many parameters - STOP'
         STOP
      END IF
...
*      IF(NCS.GE.300*3) STOP '<INITCS> too many constraints'
*      IF(NCS.GE.MGLOBL) STOP '<INITCS> too many constraints'
      DO I=1,NAGB
...
*         global correlation
       ...
       END IF
       IF(I.LE.1000.OR.NAGB-I.LE.1000) THEN
          PATEXT='  '
