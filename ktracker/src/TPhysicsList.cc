...
// ********************************************************************
//
// $Id: TPhysicsList.cc,v 1.3 2009/05/14 13:54:34 arce Exp $
...
//------------------------------------------------------------------------
TPhysicsList::TPhysicsList():  G4VUserPhysicsList()
{
...
//------------------------------------------------------------------------
void TPhysicsList::ConstructParticle()
{
...
void TPhysicsList::ConstructProcess()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (!particle->IsShortLived()) {
      G4cout << particle << "TPhysicsList:: particle process manager " << particle->GetParticleName() << " = " << particle->GetProcessManager() << G4endl;
      // Add transportation process for all particles other than  "shortlived"
      if ( pmanager == 0) {
        // Error !! no process manager
        G4String particleName = particle->GetParticleName();
        G4Exception("TPhysicsList::ConstructProcess","No process manager",
...
void TPhysicsList::ConstructEM()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    // gamma
      ...
      pmanager->AddDiscreteProcess( magFieldLimitProcess, 2 );     
