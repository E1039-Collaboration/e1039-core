...
PHG4SquareTubeSteppingAction::PHG4SquareTubeSteppingAction(PHG4SquareTubeDetector* detector, const PHParameters* parameters)
  : detector_(detector)
  , params(parameters)
  , hits_(nullptr)
  , hit(nullptr)
...
PHG4SquareTubeSteppingAction::~PHG4SquareTubeSteppingAction()
{
...
//____________________________________________________________________________..
bool PHG4SquareTubeSteppingAction::UserSteppingAction(const G4Step* aStep, bool)
{
...
//____________________________________________________________________________..
void PHG4SquareTubeSteppingAction::SetInterfacePointers(PHCompositeNode* topNode)
{
  string hitnodename;
  ...
  if (!hits_)
  {
    std::cout << "PHG4SquareTubeSteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
  }
}
