...
PHG4E1039InsensSubsystem::PHG4E1039InsensSubsystem(const std::string &name, const int lyr)
...
//_______________________________________________________________________
int PHG4E1039InsensSubsystem::InitRunSubsystem(PHCompositeNode *topNode)
{
  PHNodeIterator iter(topNode);
  PHCompositeNode *dstNode = dynamic_cast<PHCompositeNode *>(iter.findFirst("PHCompositeNode", "DST"));

  // create detector
  _detector = new PHG4E1039InsensDetector(topNode, GetParams(), Name(), GetLayer());
  ...
  if (GetParams()->get_int_param("active"))
  {
    ...
    _steppingAction = new PHG4E1039InsensSteppingAction(_detector, GetParams());
  }
...
//_______________________________________________________________________
int PHG4E1039InsensSubsystem::process_event(PHCompositeNode *topNode)
{
...
//_______________________________________________________________________
PHG4Detector *
PHG4E1039InsensSubsystem::GetDetector(void) const
{
  return _detector;
}

void PHG4E1039InsensSubsystem::SetDefaultParameters()
{
