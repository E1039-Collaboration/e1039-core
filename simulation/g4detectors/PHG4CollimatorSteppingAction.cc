...
PHG4CollimatorSteppingAction::PHG4CollimatorSteppingAction(PHG4CollimatorDetector* detector, const PHParameters* parameters)
  : detector_(detector)
  , params(parameters)
  , hits_(nullptr)
  , hit(nullptr)
...
PHG4CollimatorSteppingAction::~PHG4CollimatorSteppingAction()
{
...
//____________________________________________________________________________..
bool PHG4CollimatorSteppingAction::UserSteppingAction(const G4Step* aStep, bool)
{
...
//____________________________________________________________________________..
void PHG4CollimatorSteppingAction::SetInterfacePointers(PHCompositeNode* topNode)
{
  string hitnodename;
  ...
  if (!hits_)
  {
    std::cout << "PHG4CollimatorSteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
  }
}
