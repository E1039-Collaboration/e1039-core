...
PHG4E1039InsensSteppingAction::PHG4E1039InsensSteppingAction(PHG4E1039InsensDetector* detector, const PHParameters* parameters)
  : detector_(detector)
  , params(parameters)
  , hits_(nullptr)
  , hit(nullptr)
...
PHG4E1039InsensSteppingAction::~PHG4E1039InsensSteppingAction()
{
...
//____________________________________________________________________________..
bool PHG4E1039InsensSteppingAction::UserSteppingAction(const G4Step* aStep, bool)
{
...
//____________________________________________________________________________..
void PHG4E1039InsensSteppingAction::SetInterfacePointers(PHCompositeNode* topNode)
{
  string hitnodename;
  ...
  if (!hits_)
  {
    std::cout << "PHG4E1039InsensSteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
  }
}
