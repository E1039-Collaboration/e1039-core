...
PHG4CollimatorSubsystem::PHG4CollimatorSubsystem(const std::string &name, const int lyr)
...
//_______________________________________________________________________
int PHG4CollimatorSubsystem::InitRunSubsystem(PHCompositeNode *topNode)
{
  PHNodeIterator iter(topNode);
  PHCompositeNode *dstNode = dynamic_cast<PHCompositeNode *>(iter.findFirst("PHCompositeNode", "DST"));

  // create detector
  _detector = new PHG4CollimatorDetector(topNode, GetParams(), Name(), GetLayer());
  ...
  if (GetParams()->get_int_param("active"))
  {
    ...
    _steppingAction = new PHG4CollimatorSteppingAction(_detector, GetParams());
  }
...
//_______________________________________________________________________
int PHG4CollimatorSubsystem::process_event(PHCompositeNode *topNode)
{
...
//_______________________________________________________________________
PHG4Detector *
PHG4CollimatorSubsystem::GetDetector(void) const
{
  return _detector;
}

void PHG4CollimatorSubsystem::SetDefaultParameters()
{
