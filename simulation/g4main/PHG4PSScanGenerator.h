#ifndef PHG4PSScanGenerator_H__
#define PHG4PSScanGenerator_H__
...
class PHG4PSScanGenerator: public PHG4ParticleGeneratorBase {
...
public:
	...
	void set_vertex_distribution_mean(const double x, const double y,
			const double z);

	//! set the width of the vertex distribution function about the mean
	void set_vertex_distribution_width(const double x, const double y,
			const double z);

	//! set an offset vector from the existing vertex
	void set_existing_vertex_offset_vector(const double x, const double y,
			const double z);
	...
	//!
	void set_pxpypz_range(const double x_min, const double x_max,
			const double y_min, const double y_max, const double z_min,
			const double z_max);
...
private:
	...
	double smearvtx(const double position, const double width,
			FUNCTION dist) const;
